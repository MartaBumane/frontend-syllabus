class FlightList{
    constructor(){
        this.flightArray = require('fs').readFileSync('flights.txt').toString().split("\n").filter(function (el) {
            return el !== '';
          });
    ...
    get listOfStartAirports(){
        ...
        return startAirports.filter(function(item, pos){return startAirports.indexOf(item)== pos;});
    }
